...
- [aarondfrancis/counselors](https://github.com/aarondfrancis/counselors) - Fan out prompts to multiple AI coding agents in parallel (1 day ago)
- [yassi/dj-control-room](https://github.com/yassi/dj-control-room) - The control room for your Django app (2 days ago)
- [boyter/cs](https://github.com/boyter/cs) - codespelunker - CLI code search tool that understands code structure and ranks results by relevance. No indexing required (4 days ago)
