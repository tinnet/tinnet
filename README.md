...
- [mitsuhiko/rye](https://github.com/mitsuhiko/rye) - An Experimental Package Management Solution for Python (1 day ago)
- [tedivm/paracelsus](https://github.com/tedivm/paracelsus) - Visualize SQLAlchemy Databases using Mermaid or Dot Diagrams. (1 day ago)
