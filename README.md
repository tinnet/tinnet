...
- [hsa00000/Urocissa](https://github.com/hsa00000/Urocissa) - Urocissa is a self-hosted gallery designed to serve massive collections, capable of handling millions of images and videos. It is built using Rust and Vue. (1 day ago)
- [devgianlu/go-librespot](https://github.com/devgianlu/go-librespot) - Yet another open source Spotify client, written in Go. (1 day ago)
- [molobrakos/volvooncall](https://github.com/molobrakos/volvooncall) - Retrieve information from the Volvo On Call (VOC) web service (3 days ago)
- [Dielee/volvo2mqtt](https://github.com/Dielee/volvo2mqtt) - Home Assistant addon for connecting AAOS Volvos (3 days ago)
- [Ixam97/CarStatsViewer](https://github.com/Ixam97/CarStatsViewer) -  (3 days ago)
