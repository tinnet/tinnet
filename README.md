...
- [adzap/validates_timeliness](https://github.com/adzap/validates_timeliness) - Date and time validation plugin for ActiveModel and Rails.  Supports multiple ORMs and allows custom date/time formats. (3 days ago)
- [xaf/omni](https://github.com/xaf/omni) - the omnipotent tool (4 days ago)
- [patsissons/shopiql](https://github.com/patsissons/shopiql) -  (4 days ago)
