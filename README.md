...
- [mitsuhiko/rye](https://github.com/mitsuhiko/rye) - An Experimental Package Management Solution for Python (today)
- [tedivm/paracelsus](https://github.com/tedivm/paracelsus) - Visualize SQLAlchemy Databases using Mermaid or Dot Diagrams. (today)
