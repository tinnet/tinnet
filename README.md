...
- [jillesvangurp/kt-search](https://github.com/jillesvangurp/kt-search) - Multi platform kotlin client for Elasticsearch &amp; Opensearch with easily extendable Kotlin DSLs for queries, mappings, bulk, and more. (today)
- [ankane/logstop](https://github.com/ankane/logstop) - Keep personal data out of your logs (5 days ago)
- [Saghen/blink.cmp](https://github.com/Saghen/blink.cmp) - Performant, batteries-included completion plugin for Neovim  (5 days ago)
- [rails/globalid](https://github.com/rails/globalid) - Identify app models with a URI (5 days ago)
- [shayonj/pg_flo](https://github.com/shayonj/pg_flo) - Stream, transform, and route PostgreSQL data in real-time. (5 days ago)
