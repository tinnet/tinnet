...
- [rakyll/hey](https://github.com/rakyll/hey) - HTTP load generator, ApacheBench (ab) replacement (3 days ago)
- [sideshowbarker/git-gloss](https://github.com/sideshowbarker/git-gloss) - ✨Makes your git logs show GitHub PR/issue/reviewer/author links (3 days ago)
- [jbangdev/jbang](https://github.com/jbangdev/jbang) - Unleash the power of Java - JBang Lets Students, Educators and Professional Developers create, edit and run self-contained source-only Java programs with unprecedented ease. (5 days ago)
- [mukel/llama3.java](https://github.com/mukel/llama3.java) - Practical Llama 3 inference in Java (5 days ago)
