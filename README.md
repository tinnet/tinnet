...
- [maxandersen/jdysk](https://github.com/maxandersen/jdysk) - java version of dysk (1 day ago)
- [wimpysworld/faff](https://github.com/wimpysworld/faff) - Drop the faff, dodge the judgment. Another bloody AI commit generator, but this one stays local 🦙 (2 days ago)
